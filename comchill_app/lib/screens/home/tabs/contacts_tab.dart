          ...
          children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  ListView.separated(
                    ...
                    separatorBuilder: (context, index) => const Divider(height: 1, indent: 76, color: surfaceColor),
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        leading: CircleAvatar(
                          ...
                          child: Text(
                            item.initials,
                            style: const TextStyle(color: secondaryTextColor, fontWeight: FontWeight.bold, fontSize: 16),
                          ),
                        ),
                        title: Text(item.name, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                        subtitle: Text(item.subtitle, style: const TextStyle(color: secondaryTextColor, fontSize: 14)),
                  ...
                  Container(height: 8, color: surfaceColor), // Séparateur de section bleuté
                  const SizedBox(height: 16),
                  ...
                  ListView.separated(
                    ...
                    separatorBuilder: (context, index) => const Divider(height: 1, indent: 76, color: thirdColor),
                    itemBuilder: (context, index) {
                            ...
                            Positioned(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color: index == 3 
                                      ? supplyColor 
                                      : (item.isOnline! ? successColor : secondaryColor.withValues(alpha: 0.1)),
            ...
            Positioned(
              ...
              child: FloatingActionButton(
                ...
                child: const Icon(Icons.person_add_alt_1, color: thirdColor, size: 26),
              ),
            ),
          ],
        ),
